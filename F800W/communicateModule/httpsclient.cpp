...
void HttpsClient::downloadProgress(qint64 bytesReceived, qint64 bytesTotal)
{
    int size = (bytesReceived*100) / bytesTotal;
    qt_debug() << "cur size:" << bytesReceived << "total size:" << bytesTotal << "propress:" << size;
}
