...
extern "C" {
     ...
     * @param[in]  width      the interval [1, 1920], image width
     * @param[in]  height     the interval [1, 1920], image height
     ...
     * @param[out] length     number of detected faces
     * @return     error code
     */

    FACE_API FaceRetCode detect(const char *image, int width, int height, FaceImageType type, float face_within_thr,  int min_face_h, FaceHandle **result, int *length);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode detectAndTrack(const char* image, int width, int height, FaceImageType type, float face_within_thr, int min_face_h, FaceHandle **result, int *length);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode refineLandmark(FaceHandle handle, Landmark *result);
     ...
     * @return     error code
     */
    FACE_API FaceRetCode getTrackId(FaceHandle handle, int *track_id);
    ...
    /**
     * release all detected FaceHandles
     * @param[in]  handle           FaceHandle array
     * @param[in]  size             the number of FaceHandle
     * @return     error code
     */
     ...
     * @param[in]  handle           bgr face handles
     ...
     * @param[in]  handle        	visible face handle array
     * @param[in]  length    		number of visible faces
     * @param[in]  ir_handle     	ir face handle array
     ...
     * @param[in]  handle			 bgr handle
     * @param[in]  handle			 ir handle
     * @param[out] result            the interval [0, 1], liveness of face
     * @return     error code
     */
